...
const TextareaAutosize = React.forwardRef(function TextareaAutosize(
  ...
  return (
    <React.Fragment>
      ...
      />
      <textarea
        // The hidden textarea is only for measurement and should not render HTML.
        // To support rendering nested HTML elements, you would need to use a contentEditable div
        // instead of a textarea for the visible input. This requires a significant refactor.
        // Textareas do not support nested HTML elements by design.
        aria-hidden
